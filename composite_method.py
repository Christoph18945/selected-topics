...
It is a Structural Design Pattern which describes a group of objects that is treated the same way as a single instance of the same type
of the objects. The purpose of the Composite Method is to Compose objects into Tree type structures to represent the whole-partial hierarchies.

One of the main advantages of using the Composite Method is that first, it allows you to compose the objects into the Tree Structure and
then work with these structures as an individual object or an entity.
...
Here we attempt to make an organizational hierarchy with sub-organization, which may have subsequent
sub-organizations, such as:
...
def main() -> None:
    """main function"""
    topLevelMenu: CompositeElement = CompositeElement("GeneralManager")
    subMenuItem1: CompositeElement = CompositeElement("Manager1")
    subMenuItem2: CompositeElement = CompositeElement("Manager2")
    subMenuItem11: LeafElement = LeafElement("Developer11")
    subMenuItem12: LeafElement = LeafElement("Developer12")
    subMenuItem21: LeafElement = LeafElement("Developer21")
    subMenuItem22: LeafElement = LeafElement("Developer22")
