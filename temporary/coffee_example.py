...
print (cafeMocha.getDescription() + ": $" + cafeMocha.getCost())
...
# finding your particular combination is difficult and time consuming. 
...
class Chocolate(Decorator):
    ...
    def __init__(self, drinkComponent):
        ...
        print(cappuccino.getDescription().strip() + ": $" + "cappuccino.getTotalCost()") 
...
# CafeMocha CafeLatte Cappuccino
# CoffeeShop
# Decaf
# Decorator
# Dry
